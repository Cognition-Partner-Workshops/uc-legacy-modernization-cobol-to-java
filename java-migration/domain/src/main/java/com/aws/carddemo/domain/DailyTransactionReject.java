...
public class DailyTransactionReject {
  ...
  String validationTrailer;

  @Column(name = "validation_fail_reason")
  Integer validationFailReason;
  ...
  public void setValidationTrailer(String v) {
    validationTrailer = v;
  }
  ...
  public void setValidationFailReason(Integer v) {
    validationFailReason = v;
  }
  ...
  public void setValidationFailReasonDesc(String v) {
    validationFailReasonDesc = v;
  }
}
